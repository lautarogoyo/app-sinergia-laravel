...
class StorePedidoCompraRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'estado_contratista_id' => 'nullable|exists:estado_contratistas,id',
            'estado_pedido_id' => 'nullable|exists:estado_pedidos,id',
            'estado_registro_id' => 'nullable|exists:estado_registros,id',
